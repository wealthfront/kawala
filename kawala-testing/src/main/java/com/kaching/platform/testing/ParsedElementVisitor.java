...
interface ParsedElementVisitor<T> {

  T caseClass(ParsedClass parsedClass);
  T caseConstructor(ParsedConstructor parsedConstructor);
  T caseMethod(ParsedMethod parsedMethod);
  T caseField(ParsedField parsedField);
